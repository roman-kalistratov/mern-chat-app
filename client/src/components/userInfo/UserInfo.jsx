...
const UserInfo = () => {
  ...
  return (
    <div className="absolute z-20 xl:relative w-full lg:min-w-[300px] sm:right-0 sm:max-w-[280px] h-full flex flex-col border-l bg-white border-light p-5 dark:border-dark  dark:bg-dark3 overflow-auto pb-2">
      <UserInfoHeader
        userInfo={userInfo}
